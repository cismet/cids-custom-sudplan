 ...
 */
public class ModelinputAggregationRenderer extends AbstractManagerAggregationRenderer
        implements RequestsFullSizeComponent {

    //~ Constructors -----------------------------------------------------------

    /**
     * Creates new form ModelinputAggregationRenderer.
     */
    public ModelinputAggregationRenderer() {
        initComponents();
    }
