...
import de.cismet.cids.custom.objecteditors.sudplan.MonitorstationEditor.VarCheckBox;
...
public class MonitorstationRenderer extends AbstractCidsBeanRenderer {
    ...
    private void initMap() {
        ...
        mappingModel.setSrs(new Crs(SMSUtils.EPSG_WGS84, SMSUtils.EPSG_WGS84, SMSUtils.EPSG_WGS84, false, true));
