 ...
 */
public class LinzSensorTitleComponent extends javax.swing.JPanel {

    //~ Static fields/initializers ---------------------------------------------

    private static final transient Logger LOG = Logger.getLogger(LinzSensorTitleComponent.class);
     ...
     */
    public LinzSensorTitleComponent() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText(NbBundle.getMessage(LinzSensorTitleComponent.class, "LinzSensorTitleComponent.lblTitle.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
