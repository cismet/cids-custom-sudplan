...
public final class MovingCameraFeature extends DefaultStyledFeature implements XStyledFeature, CameraChangedListener {
    ...
    public MovingCameraFeature() {
        ...
        if (canvas3d == null) {
            ...
            final Vector2d camDir;
            if (canvas3d.getCameraDirection() == null) {
                camDir = iconDirection;
            } else {
                camDir = new Vector2d(canvas3d.getCameraDirection().x, canvas3d.getCameraDirection().y);
            }
